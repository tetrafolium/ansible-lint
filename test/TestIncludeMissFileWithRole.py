...
PLAY_ROLE_INCLUDED_IN_THE_PLACE = PlayFile(
    'roles/include_in_the_place/tasks/main.yml', u'''
---
- include_tasks: included_file.yml
''')

PLAY_ROLE_INCLUDED_RELATIVE = PlayFile(
    'roles/include_relative/tasks/main.yml', u'''
---
- include_tasks: tasks/included_file.yml
''')

PLAY_ROLE_INCLUDED_MISS = PlayFile(
    'roles/include_miss/tasks/main.yml', u'''
---
- include_tasks: tasks/noexist_file.yml
''')

PLAY_INCLUDED_IN_THE_PLACE = PlayFile(
    'roles/include_in_the_place/tasks/included_file.yml', u'''
- debug:
    msg: 'was found & included'
''')

PLAY_INCLUDED_RELATIVE = PlayFile(
    'roles/include_relative/tasks/included_file.yml', u'''
- debug:
    msg: 'was found & included'
''')
...
@pytest.mark.parametrize(
    '_play_files', (pytest.param([PLAY_MISS_INCLUDE, PLAY_ROLE_INCLUDED_MISS],
...
@pytest.mark.parametrize(
    '_play_files',
    (pytest.param([
        PLAY_IN_THE_PLACE, PLAY_ROLE_INCLUDED_IN_THE_PLACE,
